...
ZipList[7] = new Array("---------------", "三義鄉", "三灣鄉", "大湖鄉", "公館鄉", "竹南鎮", "西湖鄉", "卓蘭鎮", "南庄鄉", "後龍鎮", "苗栗市", "苑裡鎮", "泰安鄉", "通霄鎮", "造橋鄉", "獅潭鄉", "銅鑼鄉", "頭份市", "頭屋鄉");
...
ZipList[9] = new Array("---------------", "二水鄉", "二林鎮", "大村鄉", "大城鄉", "北斗鎮", "永靖鄉", "田中鎮", "田尾鄉", "竹塘鄉", "伸港鄉", "秀水鄉", "和美鎮", "社頭鄉", "芳苑鄉", "花壇鄉", "芬園鄉", "員林市", "埔心鄉", "埔鹽鄉", "埤頭鄉", "鹿港鎮", "溪州鄉", "溪湖鎮", "彰化市", "福興鄉", "線西鄉");
...
ZipList[14] = new Array("---------------", "七股區", "下營區", "大內區", "山上區", "中西區", "仁德區", "六甲區", "北門區", "北區", "左鎮區", "永康區", "玉井區", "白河區", "安平區", "安定區", "安南區", "西區", "西港區", "佳里區", "官田區", "東山區", "東區", "南化區", "南區", "後壁區", "柳營區", "將軍區", "麻豆區", "善化區", "新化區", "新市區", "新營區", "楠西區", "學甲區", "龍崎區", "歸仁區", "關廟區", "鹽水區");
...
ZipList[15] = new Array("---------------", "三民區", "大社區", "大寮區", "大樹區", "小港區", "仁武區", "內門區", "六龜區", "左營區", "永安區", "田寮區", "甲仙區", "杉林區", "那瑪夏", "岡山區", "林園區", "阿蓮區", "前金區", "前鎮區", "美濃區", "茄萣區", "茂林區", "苓雅區", "桃源區", "梓官區", "鳥松區", "湖內區", "新興區", "楠梓區", "路竹區", "鼓山區", "旗山區", "旗津區", "鳳山區", "橋頭區", "燕巢區", "彌陀區", "鹽埕區");
ZipCode[15] = new Array("", "807", "815", "831", "840", "812", "814", "845", "844", "813", "828", "823", "847", "846", "849", "820", "832", "822", "801", "806", "843", "852", "851", "802", "848", "826", "833", "829", "800", "811", "821", "804", "842", "805", "830", "825", "824", "827", "803");
...
TccList[0] = new Array("---------------");
TccCode[0] = new Array("");
TccList[1] = new Array("---------------", "旅行社-觀光旅遊", "旅行社");
TccCode[1] = new Array("", "7901", "7900");
...
TccList[9] = new Array("---------------", "未分類其他服務業", "運動場館", "身心障礙者福利服務業", "未分類其他零售業", "攝影器材及沖洗專賣店");
TccCode[9] = new Array("", "9511", "9312", "8203", "4850", "4749");
